...
document.addEventListener('DOMContentLoaded', function(){
  ...
  fetch('http://api.imagendigital.com/v2/cocinadelirante/node.json/339fd1e0444ddbbd4d4528d8df161108?taxonomy.tid=13&fields=id,title,url,image,author,created,taxonomy.name&type=receta&limit=6')
    ...
    .then(function(myJSONCarrousel) {
        ...
        let timeStampCarrousel6=myJSONCarrousel.data["4"].created;
        ...
        <!-- <div class="slider-example"> -->
            <div class="carrousel-card-node">
                ...
                <div class=carrousel-card-content onclick="location.href='#';" style="cursor: pointer;">
                    ...
                    <h2>` + myJSONCarrousel.data["0"].image.description + `</h2>
            ...
            <div class="carrousel-card-node">
                ...
                <div class=carrousel-card-content onclick="location.href='#';" style="cursor: pointer;">
                    ...
                    <h2>` + myJSONCarrousel.data["1"].image.description + `</h2>
            ...
            <div class="carrousel-card-node">
                ...
                <div class=carrousel-card-content onclick="location.href='#';" style="cursor: pointer;">
                    ...
                    <h2>` + myJSONCarrousel.data["2"].image.description + `</h2>
            ...
            <div class="carrousel-card-node">
                ...
                <div class=carrousel-card-content onclick="location.href='#';" style="cursor: pointer;">
                    ...
                    <h2>` + myJSONCarrousel.data["3"].image.description + `</h2>
            ...
            <div class="carrousel-card-node">
                ...
                <div class=carrousel-card-content onclick="location.href='#';" style="cursor: pointer;">
                    ...
                    <h2>` + myJSONCarrousel.data["4"].image.description + `</h2>
            ...
            <div class="carrousel-card-node">
                ...
                <div class=carrousel-card-content onclick="location.href='#';" style="cursor: pointer;">
                    ...
                    <h2>` + myJSONCarrousel.data["5"].image.description + `</h2>
...
document.addEventListener('DOMContentLoaded', function(){
  ...
  fetch('http://api.imagendigital.com/v2/cocinadelirante/node.json/339fd1e0444ddbbd4d4528d8df161108?taxonomy.tid=13&fields=id,title,url,image,preference,taxonomy.name&type=receta&limit=3&offset=6')
    .then(function(respuesta) {
      return respuesta.json();
    })
    .then(function(myJSONHealthy) {
      ...
      <div class=card-node>
            <div class=card-image>
                <a href=""><img src="` + myJSONHealthy.data["0"].image.url + `" alt="` + myJSONHealthy.data["0"].image.description + `"></a>
            </div>
            <div class=card-content onclick="location.href='#';" style="cursor: pointer;">
                <div class=border>
                <p>` + myJSONHealthy.data["0"].taxonomy.name + `</p>
                <h2>` + myJSONHealthy.data["0"].preference.name + `</h2>
            </div>
            </div>
        </div>
        <div class=card-node>
            <div class=card-image>
                <a href=""><img src="` + myJSONHealthy.data["1"].image.url + `" alt="` + myJSONHealthy.data["1"].image.description + `"></a>
            </div>
            <div class=card-content onclick="location.href='#';" style="cursor: pointer;">
                <div class=border>
                <p>` + myJSONHealthy.data["1"].taxonomy.name + `</p>
                <h2>` + myJSONHealthy.data["1"].preference.name + `</h2>
                </div>
            </div>
        </div>
        <div class=card-node>
            <div class=card-image>
                <a href=""><img src="` + myJSONHealthy.data["2"].image.url + `" alt="` + myJSONHealthy.data["2"].image.description + `"></a>
            </div>
            <div class=card-content onclick="location.href='#';" style="cursor: pointer;">
                <div class=border>
                <p>` + myJSONHealthy.data["2"].taxonomy.name + `</p>
                <h2>` + myJSONHealthy.data["2"].preference.name + `</h2>
            </div>
            </div>
        </div>`;
    })
